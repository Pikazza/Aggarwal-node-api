...
const checksumController = require('../controllers/checksum-controller');

module.exports = function(router){

		router.get('/v1.0/checksum', checksumController.get),
		router.post('/v1.0/generate_checksum', checksumController.generate),
		router.post('/v1.0/verify_checksum', checksumController.verify)
}
